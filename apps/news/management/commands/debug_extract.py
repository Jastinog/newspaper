...
class Command(BaseCommand):
    ...
    def _show_errors(self):
        """Show breakdown of stored extract_error values."""
    ...
    def _show_error_detail(self, category: str):
        """Show sample articles for a specific error category."""
        articles = (
    ...
    def _test_url(self, url: str):
        ...
        _id, text, err_cat, err_msg = _fetch_and_extract(0, url)
    ...
    def _test_sample(self, n: int):
        """Test extraction on N random unfetched articles."""
        articles = list(
        ...
        for aid, url, title, feed_title in articles:
            ...
            _id, text, err_cat, err_msg = _fetch_and_extract(aid, url)
    ...
    def _retry_failed(self, n: int):
        """Retry N previously failed articles with verbose output."""
        articles = list(
            Article.objects.filter(
                content_fetched=True,
                extract_error__gt="",
        ...
        for a in articles:
            ...
            _id, text, err_cat, err_msg = _fetch_and_extract(a.id, a.url)
